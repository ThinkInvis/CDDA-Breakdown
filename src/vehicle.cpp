...
int vehicle::fuel_left( const itype_id &ftype, bool recurse ) const
{
    ...
    const vehicle_part & rhs ) {
        ...
        // BD TODO: add an antifreeze part in addition/instead (something like 'water heater')
        if( rhs.is_tank() && rhs.base.contents_made_of( SOLID ) && !get_option<bool>("VEH_ANTIFREEZE") ) {
